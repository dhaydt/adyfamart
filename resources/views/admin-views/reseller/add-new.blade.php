...
@section('title', \App\CPU\translate('Reseller_Add'))
@push('css_or_js')
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('reseller_add')}}</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    {{\App\CPU\translate('reseller_form')}}
                </div>
                <div class="card-body">
                    <form action="{{route('admin.reseller.add-new')}}" method="post" enctype="multipart/form-data"
