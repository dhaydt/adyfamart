...
@section('title', \App\CPU\translate('Reseller_List'))
@push('css_or_js')
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('Reseller')}}</li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{\App\CPU\translate('reseller_table')}}</h5>
                    <a href="{{route('admin.reseller.add-new')}}" class="btn btn-primary  float-right">
                        ...
                        <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            @if($e->role)
                                <tr>
                                    ...
                                    <td>{{$e->role['name']}}</td>
                                    <td>
                                        <a href="{{route('admin.reseller.update',[$e['id']])}}"
